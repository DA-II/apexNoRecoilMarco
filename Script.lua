...
CAR_offset_list = {
	...
	{16,3,2,3},					{17,2,1,3},					{18,0,1,3},

	{19,-2,0,3},					{20,-3,-1,3},					{21,-2,1,3},

	{22,2,1,3},					{23,0,0,3},					{24,0,1,3},
...
HWK_offset_list = {
	...
	{7 ,2,6,3},					{8 ,2,7,3},					{9 ,2,4,3},

	{10,-1,4,3},				{11,-3,4,3},				{12,-5,2,3},

	{13,-5,-1,3},				{14,-3,-1,3},				{15,-3,3,3},

	{16,-1,2,3},				{17,5,2,3},					{18,5,2,3},

	{19,3,4,3},					{20,3,3,3},					{21,2,4,3},

	{22,2,5,3},					{23,1,4,3},					{24,2,5,3},

	{25,2,4,3},					{26,3,4,3},					{27,3,4,3},

	{28,3,5,3},					{29,2,4,3},					{30,1,6,3},
...
DN_offset_list = {
	...
	{1 ,-1,6,4},					{2 ,0,5,4},					{3 ,0,5,4},

	{4 ,0,5,4},					{5 ,-1,5,4},					{6 ,-2,6,4},

	{7 ,1,5,4},					{8 ,-1,6,4},					{9 ,-1,4,4},

	{10,1,2,4},					{11,1,1,4},					{12,2,1,4},

	{13,3,1,4},					{14,2,2,4},					{15,-1,1,4},

	{16,-2,1,4},					{17,0,1,4},					{18,0,0,4},

	{19,1,1,4},					{20,0,2,4},					{21,1,1,4},
...
text_di = {231,172,172,32,32}		text_qiang = {32,32,230,158,170}
...
-- 腰射
		...
		if(kg == 2 or kg == 4) then
			...
			if turbo_state == 0 and offset_state == "HWK" then	Sleep(425)	end
